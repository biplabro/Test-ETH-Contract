...
const lotteryPath = path.resolve(__dirname, 'contracts', 'Lottery.sol') //mention the path variable, __dirname = working directory, for cross platform compatibility
const source = fs.readFileSync(lotteryPath, 'utf8') //read the contents of the contract/file, mention encoding
...
// snippet 2
module.exports = solc.compile(source,1).contracts[':Lottery'] //compile & export the contract properties making it an available resource for the rest of the codebase
